...
namespace ProjetoWindowsForms
{
    public partial class Frm_ValidaSenha : Form
    {
        ...
        private void Txt_Senha_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (forca == ChecaForcaSenha.ForcaDaSenha.Inaceitavel || forca == ChecaForcaSenha.ForcaDaSenha.Fraca)
            {
                Lbl_Resultado.ForeColor = Color.Red;
            }
            else if (forca == ChecaForcaSenha.ForcaDaSenha.Aceitavel)
            {
                Lbl_Resultado.ForeColor = Color.Blue;
            }
            else if (forca == ChecaForcaSenha.ForcaDaSenha.Forte || forca == ChecaForcaSenha.ForcaDaSenha.Segura)
            {
